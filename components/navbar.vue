...
<template>
    <div class="h-screen flex items-start" v-motion-slide-visible-left>
        <ul class="bg-slate-950 flex flex-col width 
         ...
         >
            ...
            <nuxt-link to="/signUp" class="mb-12">👨🏻‍💻<br> Login</nuxt-link> 
            <nuxt-link to="/login" class="mb-12">🧾<br> Sign Up</nuxt-link> 
